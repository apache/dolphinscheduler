...
public enum MessageType {
    ...
    REGISTRY_LISTENER_PLUGIN,
    REMOVE_LISTENER_PLUGIN,
    UPDATE_LISTENER_PLUGIN,
    CREATE_LISTENER_PLUGIN_INSTANCE,
    UPDATE_LISTENER_PLUGIN_INSTANCE,
    REMOVE_LISTENER_PLUGIN_INSTANCE;
