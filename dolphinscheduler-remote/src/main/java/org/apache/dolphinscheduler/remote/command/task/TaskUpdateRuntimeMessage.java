...
public class TaskUpdateRuntimeMessage extends BaseMessage {
    ...
    public TaskUpdateRuntimeMessage(String messageSenderAddress, String messageReceiverAddress, long messageSendTime) {
