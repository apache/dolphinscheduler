...
package org.apache.dolphinscheduler.extract.listener.request;
...
@Data
@ToString
public class ListenerResponse<T> {
    ...
    public static <T> ListenerResponse<T> success() {
        return new ListenerResponse<>(true, "success", null);
    }

    public static <T> ListenerResponse<T> success(T data) {
        return new ListenerResponse<>(true, "success", data);
    }
