...
Source Server         : 172.16.129.117_13309
Source Server Version : 50722
Source Host           : 172.16.129.117:13309
Source Database       : dolphinscheduler

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2020-11-13 17:48:33
*/
...
VALUES ('2', '1', '3f4d80bc5f5da6da375716b4bd7125d2', '2100-04-30 11:00:00', '2020-11-13 03:47:37',
        '2020-11-13 03:47:37');
...
(
    ...
    `resource_ids`            text COMMENT 'resource ids',
    PRIMARY KEY (`id`),
...
VALUES ('2', 'athena', '', '3', '1', '2020-11-13 03:48:03', '2020-11-13 03:48:03');
...
(
    `id`           int(11) NOT NULL AUTO_INCREMENT COMMENT 'key',
    `alias`        varchar(256) DEFAULT NULL COMMENT 'alias',
    `file_name`    varchar(256) DEFAULT NULL COMMENT 'file name',
    ...
    `create_time`  datetime     DEFAULT NULL COMMENT 'create time',
    `update_time`  datetime     DEFAULT NULL COMMENT 'update time',
    `pid`          int(11)      DEFAULT '-1' COMMENT 'parent id',
    `full_name`    varchar(255) DEFAULT NULL COMMENT 'full name',
    `is_directory` tinyint(1)   DEFAULT '0' COMMENT 'is directory',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 12363
  DEFAULT CHARSET = utf8;
...
-- ----------------------------
INSERT INTO `t_ds_session`
VALUES ('ec5bf332-ad47-4481-8a61-56d3237dea4a', '3', '172.16.133.200', '2020-11-13 03:47:53');
...
VALUES ('2', 'root', 'root', '', '1', '2020-11-13 03:45:47', '2020-11-13 03:45:47');
...
INSERT INTO `t_ds_user`
VALUES ('3', 'athena', '0d251e25ebcc810ddcecf1f698ac51f8', '1', '411018891@qq.com', '', '2', '2020-11-13 03:46:19',
