...
delimiter d//
CREATE PROCEDURE alter_t_ds_task_definition1234()
BEGIN
ALTER TABLE t_ds_task_definition ADD COLUMN task_group_id int(11) DEFAULT -1;
END;

d//

delimiter ;
CALL alter_t_ds_task_definition1234;
DROP PROCEDURE alter_t_ds_task_definition1234;


-- create task group queue table
delimiter d//
CREATE PROCEDURE alter_t_ds_task_definition_log()
BEGIN
ALTER TABLE t_ds_task_definition_log ADD COLUMN task_group_id int(11) DEFAULT -1;
END;

d//

delimiter ;
CALL alter_t_ds_task_definition_log;
DROP PROCEDURE alter_t_ds_task_definition_log;