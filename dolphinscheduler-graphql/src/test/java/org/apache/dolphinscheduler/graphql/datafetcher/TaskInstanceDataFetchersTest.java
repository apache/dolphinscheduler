...
public class TaskInstanceDataFetchersTest extends AbstractDataFetchersTest {

    private static Logger logger = LoggerFactory.getLogger(TaskInstanceDataFetchersTest.class);

    @Test
    public void testQueryTaskListPaging() throws Exception {
        HashMap<String, String> paramsMap = new HashMap<>();
        paramsMap.put("query",
                "query queryTaskListPaging {\n" +
                        "queryTaskListPaging(\n" +
