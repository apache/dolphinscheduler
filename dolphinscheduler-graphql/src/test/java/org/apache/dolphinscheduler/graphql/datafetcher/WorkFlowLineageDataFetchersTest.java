...
public class WorkFlowLineageDataFetchersTest extends AbstractDataFetchersTest {

    private static Logger logger = LoggerFactory.getLogger(WorkFlowLineageDataFetchersTest.class);

    @Test
    public  void testQueryWorkFlowLineageByCode() throws Exception {
        HashMap<String, String> paramsMap = new HashMap<>();
        paramsMap.put("query",
                "query queryWorkFlowLineageByIds {\n" +
