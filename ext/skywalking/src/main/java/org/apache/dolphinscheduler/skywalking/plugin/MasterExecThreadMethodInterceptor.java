...
public class MasterExecThreadMethodInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        String operationName = OPERATION_NAME_PREFIX + getProjectId(processDefinition.getProjectCode()) + "/" + processDefinition.getName();

        AbstractSpan span = ContextManager.createLocalSpan(operationName);
        span.setComponent(Utils.DOLPHIN_SCHEDULER);
        TAG_PROJECT_ID.set(span, String.valueOf(processDefinition.getProjectCode()));
        ...
        TAG_PROCESS_DEFINITION_ID.set(span, String.valueOf(processInstance.getProcessDefinitionCode()));
