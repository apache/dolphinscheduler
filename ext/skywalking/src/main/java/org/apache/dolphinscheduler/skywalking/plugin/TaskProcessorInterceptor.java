...
public class TaskProcessorInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        final EnhancedInstance enhancedInstance = (EnhancedInstance) taskPriority;
        ...
        Map<String, String> taskPriorityContext = taskPriority.getContext();
