...
public class TaskExecuteMethodInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        TaskContext<TaskRequest> taskContext = (TaskContext<TaskRequest>) objInst.getSkyWalkingDynamicField();
    ...
    private void logTaskParams(EnhancedInstance objInst) {
        //noinspection unchecked
        TaskContext<TaskRequest> taskContext = (TaskContext) objInst.getSkyWalkingDynamicField();
        TaskRequest executionContext = taskContext.getCache();
