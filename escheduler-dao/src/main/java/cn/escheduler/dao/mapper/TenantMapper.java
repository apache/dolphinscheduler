...
public interface TenantMapper {
    ...
    @Results(value = {@Result(property = "id", column = "id", id = true, javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "queueName", column = "queue_name", javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "queue", column = "queue", javaType = Integer.class, jdbcType = JdbcType.INTEGER),
