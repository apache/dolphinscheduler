...
@ComponentScan(includeFilters = {@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = CreateDolphinScheduler.CreateRunner.class)}, useDefaultFilters = false)
