 ...
 */
@Service
public class ProcessInstanceServiceImpl extends BaseDAGService implements ProcessInstanceService {
     ...
     * @param startTime the start time of top n
     * @param endTime the end time of top n
     * @return top n process instance info result
     */
    ...
    public Map<String, Object> viewVariables(Integer processInstanceId) {
        ...
        if (processInstance == null) {
            throw new ServiceException("workflow instance is null");
        }
