...
public class DataAnalysisController extends BaseController {
    ...
    @ControllerException(Status.TASK_INSTANCE_STATE_COUNT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.COUNT_PROCESS_INSTANCE_STATE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.COUNT_PROCESS_DEFINITION_USER_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.COMMAND_STATE_COUNT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.QUEUE_COUNT_ERROR)
