...
public class UsersController extends BaseController {
    ...
    @ControllerException(CREATE_USER_ERROR)
    ...
    @ControllerException(QUERY_USER_LIST_PAGING_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(UPDATE_USER_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_USER_BY_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(GRANT_PROJECT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(GRANT_RESOURCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(GRANT_UDF_FUNCTION_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(GRANT_DATASOURCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(GET_USER_INFO_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(USER_LIST_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(VERIFY_USERNAME_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(UNAUTHORIZED_USER_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(AUTHORIZED_USER_ERROR)
