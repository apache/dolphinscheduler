...
public interface DataSourceService {
     ...
     */
    Map<String, Object> createDataSource(User loginUser, String name, String desc, DbType type, String parameter);
     ...
     */
    Map<String, Object> updateDataSource(int id, User loginUser, String name, String desc, DbType type, String parameter);
     ...
     */
    Result verifyDataSourceName(User loginUser, String name);
     ...
     */
    boolean connectionTest(User loginUser, int id);
     ...
     */
    String buildParameter(String name, String desc, DbType type, String host,
     ...
     */
    Result delete(User loginUser, int datasourceId);
