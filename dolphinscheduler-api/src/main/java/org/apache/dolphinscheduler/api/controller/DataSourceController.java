...
import static org.apache.dolphinscheduler.api.enums.Status.UPDATE_DATASOURCE_PASSWORD_ERROR;
import static org.apache.dolphinscheduler.api.enums.Status.VERIFY_DATASOURCE_NAME_FAILURE;

import org.apache.dolphinscheduler.api.audit.OperatorLog;
import org.apache.dolphinscheduler.api.audit.enums.AuditType;
import org.apache.dolphinscheduler.api.dto.UpdateDataSourcePasswordRequest;
...
public class DataSourceController extends BaseController {
     ...
     * @param loginUser login user
     * @param id        datasource id
     * @param request   datasource password update request
     *
     * @return update result code
     */
    @Operation(summary = "updateDataSourcePassword", description = "UPDATE_DATA_SOURCE_PASSWORD_NOTES")
    @Parameters({
            @Parameter(name = "id", description = "DATA_SOURCE_ID", required = true, schema = @Schema(implementation = int.class))
    })
    @PutMapping(value = "/password/{id}")
    @ResponseStatus(HttpStatus.OK)
    @ApiException(UPDATE_DATASOURCE_PASSWORD_ERROR)
    @OperatorLog(auditType = AuditType.DATASOURCE_UPDATE)
    public Result<DataSource> updateDataSourcePassword(@Parameter(hidden = true) @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
                                                       @PathVariable(value = "id") Integer id,
                                                       @RequestBody UpdateDataSourcePasswordRequest request) {
        DataSource dataSource = dataSourceService.updateDataSourcePassword(loginUser, id, request.getPassword(),
