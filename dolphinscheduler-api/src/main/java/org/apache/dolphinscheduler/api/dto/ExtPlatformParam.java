...
public class ExtPlatformParam {
  ...
  public ExtPlatformParam() {

  }


  public ExtPlatformParam(String url, int urlType) {
    this.url = url;
    this.urlType = urlType;
  }

  public ExtPlatformParam(String name , String url, int urlType) {
    this.name = name ;
    this.url = url;
    this.urlType = urlType;
  }
