...
public class TenantController extends BaseController {
    ...
    @ControllerException(CREATE_TENANT_ERROR)
    ...
    @ControllerException(QUERY_TENANT_LIST_PAGING_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_TENANT_LIST_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(UPDATE_TENANT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_TENANT_BY_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(VERIFY_TENANT_CODE_ERROR)
