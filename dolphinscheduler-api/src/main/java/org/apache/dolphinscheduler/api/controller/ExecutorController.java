...
public class ExecutorController extends BaseController {
    ...
    @ControllerException(START_PROCESS_INSTANCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(EXECUTE_PROCESS_INSTANCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(CHECK_PROCESS_DEFINITION_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_RECIPIENTS_AND_COPYERS_BY_PROCESS_DEFINITION_ERROR)
