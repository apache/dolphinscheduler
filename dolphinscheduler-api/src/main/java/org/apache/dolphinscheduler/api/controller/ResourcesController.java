...
public class ResourcesController extends BaseController {
    ...
    @ControllerException(CREATE_RESOURCE_ERROR)
    ...
    @ControllerException(UPDATE_RESOURCE_ERROR)
    ...
    @ControllerException(QUERY_RESOURCES_LIST_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_RESOURCES_LIST_PAGING)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_RESOURCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(VERIFY_RESOURCE_BY_NAME_AND_TYPE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(RESOURCE_NOT_EXIST)
    ...
    @ControllerException(VIEW_RESOURCE_FILE_ON_LINE_ERROR)
    ...
    @ControllerException(CREATE_RESOURCE_FILE_ON_LINE_ERROR)
    ...
    @ControllerException(EDIT_RESOURCE_FILE_ON_LINE_ERROR)
    ...
    @ResponseBody
    @ControllerException(DOWNLOAD_RESOURCE_FILE_ERROR)
    ...
    @ControllerException(CREATE_UDF_FUNCTION_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(VIEW_UDF_FUNCTION_ERROR)
    ...
    @ControllerException(UPDATE_UDF_FUNCTION_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_UDF_FUNCTION_LIST_PAGING_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_DATASOURCE_BY_TYPE_ERROR)
    public Result queryResourceList(@ApiIgnore @RequestAttribute(value = Constants.SESSION_USER) User loginUser,
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(VERIFY_UDF_FUNCTION_NAME_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_UDF_FUNCTION_ERROR)
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ControllerException(AUTHORIZED_FILE_RESOURCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ControllerException(AUTHORIZE_RESOURCE_TREE)
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ControllerException(UNAUTHORIZED_UDF_FUNCTION_ERROR)
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @ControllerException(AUTHORIZED_UDF_FUNCTION_ERROR)
