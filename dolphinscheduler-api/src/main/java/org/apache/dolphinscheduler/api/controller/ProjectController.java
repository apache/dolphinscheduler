...
public class ProjectController extends BaseController {
    ...
    @ControllerException(CREATE_PROJECT_ERROR)
    ...
    @ControllerException(UPDATE_PROJECT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_PROJECT_DETAILS_BY_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(LOGIN_USER_QUERY_PROJECT_LIST_PAGING_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_PROJECT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_UNAUTHORIZED_PROJECT_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_AUTHORIZED_PROJECT)
    ...
    @ControllerException(IMPORT_PROCESS_DEFINE_ERROR)
