...
public class ResourcesServiceImpl extends BaseService implements ResourcesService {
    ...
    public Result<Map<String, Object>> createDirectory(User loginUser,
                                                       String name,
                                                       String description,
                                                       ResourceType type,
                                                       int pid,
     ...
     */
    @Transactional(rollbackFor = RuntimeException.class)
    public Result<Map<String, Object>> updateResource(User loginUser,
                                                      int resourceId,
                                                      String name,
                                                      String desc,
                                                      ResourceType type) {
    ...
    public Result delete(User loginUser, int resourceId) throws Exception {
        ...
        Integer[] needDeleteResourceIdArray = allChildren.toArray(new Integer[0]);
     ...
     */
    private <T> void getAuthorizedResourceList(Set<T> resourceSet, List<T> authedResourceList) {
        Set<T> authedResourceSet;
     ...
     */
    private List<Integer> listAllChildren(Resource resource, boolean containSelf) {
     ...
     */
    private void listAllChildren(int resourceId, List<Integer> childList) {
