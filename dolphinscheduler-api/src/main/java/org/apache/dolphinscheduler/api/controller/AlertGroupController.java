...
public class AlertGroupController extends BaseController {
    ...
    @ControllerException(Status.CREATE_ALERT_GROUP_ERROR)
    ...
    @ControllerException(Status.QUERY_ALL_ALERTGROUP_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.LIST_PAGING_ALERT_GROUP_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.UPDATE_ALERT_GROUP_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.DELETE_ALERT_GROUP_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(Status.ALERT_GROUP_GRANT_USER_ERROR)
