...
public class ProcessInstanceController extends BaseController {
     ...
     * @param executorName execurot name
    ...
    @ControllerException(QUERY_PROCESS_INSTANCE_LIST_PAGING_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_TASK_LIST_BY_PROCESS_INSTANCE_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(UPDATE_PROCESS_INSTANCE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_PROCESS_INSTANCE_BY_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(DELETE_PROCESS_INSTANCE_BY_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_SUB_PROCESS_INSTANCE_DETAIL_INFO_BY_TASK_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_PARENT_PROCESS_INSTANCE_DETAIL_INFO_BY_SUB_PROCESS_INSTANCE_ID_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(QUERY_PROCESS_INSTANCE_ALL_VARIABLES_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(ENCAPSULATION_PROCESS_INSTANCE_GANTT_STRUCTURE_ERROR)
    ...
    @ResponseStatus(HttpStatus.OK)
    @ControllerException(BATCH_DELETE_PROCESS_INSTANCE_BY_IDS_ERROR)
