...
public class ProcessInstanceController extends BaseController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "PROCESS_DEFINITION_NAME", schema = @Schema(implementation = String.class)),
            @Parameter(name = "description", description = "PROCESS_DEFINITION_DESC", schema = @Schema(implementation = String.class)),
