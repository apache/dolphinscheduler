...
public enum Status {
    ...
    QUERY_PLUGINS_RESULT_IS_NULL(110002, "query alarm plugins result is empty, please check whether the alarm component is started and the plugin is successfully registered", "查询告警插件为空, 请检查告警组件是否启动相关告警插件是否注册成功"),
