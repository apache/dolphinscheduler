...
public enum Status {
    ...
    SWITCH_WORKFLOW_DEFINITION_VERSION_NOT_EXIST_PROCESS_DEFINITION_ERROR(10152,
            "Switch workflow definition version error: not exists workflow definition, [process definition id {0}]",
            "切换工作流版本出错：工作流不存在，[工作流id {0}]"),
    SWITCH_WORKFLOW_DEFINITION_VERSION_NOT_EXIST_WORKFLOW_DEFINITION_VERSION_ERROR(10153,
            "Switch process definition version error: not exists workflow definition version, [process definition id {0}] [version number {1}]",
