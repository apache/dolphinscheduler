...
public enum Status {
    ...
    COPY_PROCESS_DEFINITION_ERROR(10148,"copy process definition {0} error : {1}", "复制工作流{0}错误:{1}"),
    USER_DISABLED(10149,"The current user is disabled", "当前用户已停用"),
    MOVE_PROCESS_DEFINITION_ERROR(10150,"move process definition {0} error : {1}", "移动工作流{0}错误:{1}"),
