...
public enum Status {
    ...
    CREATE_TASK_DEFINITION_LOG_ERROR(50060, "create task definition log {0} error", "创建任务操作记录 {0} 错误"),
    DELETE_TASK_DEFINE_BY_CODE_MSG_ERROR(50061, "delete task definition {0} error", "删除任务定义 {0} 错误"),
    TASK_DEFINITION_NOT_CHANGE(50062, "task definition {0} do not change", "任务定义 {0} 没有变化"),
    TASK_DEFINITION_NOT_EXISTS(50063, "task definition {0} do not exists", "任务定义 {0} 不存在"),
    UPDATE_UPSTREAM_TASK_PROCESS_RELATION_ERROR(50064, "update task upstream relation error", "更新任务上游关系错误"),
    CREATE_PROCESS_TASK_RELATION_LOG_ERROR(50065, "create process task relation log {0}-{1} error",
            "创建任务关系日志 {0}-{1} 错误"),
    PROCESS_TASK_RELATION_NOT_EXPECT(50066, "process task relation number not expect, expect {0} but get {1}",
            "工作流任务关系数量不符合预期，预期 {0} 但是实际 {1}"),
    PROCESS_TASK_RELATION_BATCH_DELETE_ERROR(50067, "batch delete process task relation {0} error",
            "批量删除工作流任务关系 {0} 错误"),
    PROCESS_TASK_RELATION_BATCH_CREATE_ERROR(50068, "batch create process task relation {0} error",
            "批量创建工作流任务关系 {0} 错误"),
