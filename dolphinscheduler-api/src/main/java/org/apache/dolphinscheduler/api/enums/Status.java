...
public enum Status {
    ...
    DELETE_WORKER_GROUP_BY_TASK_ID_FAIL(10155, "delete worker group by id fail, for there are {0} task instances in executing using it", "删除Worker分组失败，有[{0}]个运行中的任务实例正在使用"),
