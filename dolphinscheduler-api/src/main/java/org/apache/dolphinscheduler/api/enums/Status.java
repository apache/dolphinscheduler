...
public enum Status {
    ...
    EXECUTE_NOT_DEFINE_TASK(10206, "please save and try again",
            "请先保存后再执行"),
    DELETE_QUEUE_BY_ID_ERROR(10207, "delete queue by id error", "删除队列错误"),
    DELETE_QUEUE_BY_ID_FAIL_USERS(10208, "delete queue by id fail, for there are {0} users using it",
            "删除队列失败，有[{0}]个用户正在使用"),
    DELETE_TENANT_BY_ID_FAIL_TENANTS(10209, "delete queue by id fail, for there are {0} tenants using it",
            "删除队列失败，有[{0}]个租户正在使用"),
