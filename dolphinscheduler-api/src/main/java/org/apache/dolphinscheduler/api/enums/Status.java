...
public enum Status {
    ...
    BATCH_DELETE_PROCESS_INSTANCE_BY_IDS_ERROR(10117, "batch delete process instance by ids error: {0}", "批量删除工作流实例错误: {0}"),
    ...
    DELETE_PROCESS_DEFINE_BY_CODES_ERROR(50060, "delete process definition by codes [{0}] error: {1}", "删除工作流定义[{0}]错误: {1}"),
