...
public enum Status {
    ...
    DELETE_PROCESS_DEFINITION_EXECUTING_FAIL(10163, "delete process definition [{0}] fail, for there are [{1}] process instances in executing using it", "删除工作流定义[{0}]失败，有[{1}]个运行中的工作流实例正在使用"),
    ...
    DELETE_PROCESS_DEFINITION_USE_BY_OTHER_FAIL(10193, "delete process definition [{0}] fail, cause used by other tasks: {1}", "删除工作流[{0}]失败，被其他任务引用：{1}"),
    ...
    BATCH_DELETE_PROCESS_DEFINE_BY_CODES_ERROR(50026, "batch delete process definition by codes error {0}", "批量删除工作流定义错误 [{0}]"),
