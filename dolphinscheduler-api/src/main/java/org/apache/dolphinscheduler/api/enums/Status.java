...
public enum Status {
    ...
    USER_NO_WRITE_PROJECT_PERM(30003, "user [{0}] does not have write permission for project [{1}]", "当前用户[{0}]没有[{1}]项目的写权限"),
    USER_NO_WRITE_RESOURCE_PERM(30004, "user [{0}] does not have write permission for resource [{1}]", "当前用户[{0}]没有[{1}]资源的写权限"),
