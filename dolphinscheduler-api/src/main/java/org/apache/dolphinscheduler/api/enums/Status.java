...
public enum Status {
    ...
    TENANT_CODE_EXIST(10009, "tenant code {0} already exists", "操作系统租户[{0}]已存在"),
    ...
    VERIFY_TENANT_CODE_ERROR(10089, "verify tenant code error", "操作系统租户验证错误"),
    ...
    TENANT_CODE_HAS_ALREADY_EXISTS(10124, "tenant code has already exists", "操作系统租户已存在"),
    ...
    CHECK_TENANT_CODE_ERROR(10164, "Please enter the English tenant code", "请输入英文操作系统租户"),
