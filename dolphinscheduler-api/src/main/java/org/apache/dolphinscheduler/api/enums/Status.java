...
public enum Status {
    ...
    LOGIN_SESSION_FAILED(10014,"create session failed!", "创建登录session失败"),
    ...
    SCHEDULE_CRON_NOT_EXISTS(10022, "scheduler crontab {0} does not exist", "调度配置不存在"),
    SCHEDULE_CRON_ONLINE_FORBID_UPDATE(10023, "online status does not allow updateProcessInstance operations", "调度配置上线状态不允许修改"),
    ...
    LIST_PAGING_ALERT_GROUP_ERROR(10029,"list paging alert group error", "查询告警组错误"),
    ...
    LOGIN_USER_QUERY_PROJECT_LIST_PAGING_ERROR(10049,"login user query project list paging error", "查询项目列表错误"),
    ...
    QUERY_RESOURCES_LIST_PAGING(10057,"query resources list paging", "查询资源列表错误"),
    ...
    CREATE_RESOURCE_FILE_ON_LINE_ERROR(10061,"create resource file online error", "线上创建资源文件错误"),
    ...
    QUERY_UDF_FUNCTION_LIST_PAGING_ERROR( 10068,"query udf function list paging error", "查询UDF函数列表错误"),
    ...
    QUERY_SCHEDULE_LIST_PAGING_ERROR(10080,"query schedule list paging error", "查询调度配置列表错误"),
    QUERY_SCHEDULE_LIST_ERROR(10081,"query schedule list error", "查询调度配置列表错误"),
    QUERY_TASK_LIST_PAGING_ERROR(10082,"query task list paging error", "查询任务列表错误"),
    QUERY_TASK_RECORD_LIST_PAGING_ERROR(10083,"query task record list paging error", "查询任务记录错误"),
    CREATE_TENANT_ERROR(10084,"create tenant error", "创建租户错误"),
    QUERY_TENANT_LIST_PAGING_ERROR(10085,"query tenant list paging error", "查询租户列表错误"),
    ...
    QUERY_USER_LIST_PAGING_ERROR(10091,"query user list paging error", "查询用户列表错误"),
    ...
    DOWNLOAD_TASK_INSTANCE_LOG_FILE_ERROR(10104,"download task instance log file error", "下载任务实例日志文件错误"),
    ...
    QUERY_PROCESS_INSTANCE_LIST_PAGING_ERROR(10113,"query process instance list paging error", "查询工作流实例列表错误"),
    ...
    QUERY_PROCCESS_DEFINITION_LIST_PAGING_ERROR(10122,"query proccess definition list paging error", "查询工作流定义列表错误"),
    ...
    DELETE_TENANT_BY_ID_FAIL(100142,"delete tenant by id fail, for there are {0} process instances in executing using it", "删除租户失败，有[{0}]个执行中的工作流实例正在使用"),
    DELETE_TENANT_BY_ID_FAIL_DEFINES(100143,"delete tenant by id fail, for there are {0} process definitions using it", "删除租户失败，有[{0}]个执行中的工作流正在使用"),
    DELETE_TENANT_BY_ID_FAIL_USERS(100144,"delete tenant by id fail, for there are {0} users using it", "删除租户失败，有[{0}]个用户正在使用"),

    DELETE_WORKER_GROUP_BY_ID_FAIL(100145,"delete worker group by id fail, for there are {0} process instances in executing using it", "删除Worker分组失败，有[{0}]个执行中的工作流实例正在使用"),
    ...
    PROCESS_DEFINE_NOT_ALLOWED_EDIT(50008, "process definition {0} does not allow edit", "工作流定义不允许修改"),
    ...
    QUERY_ACCESSTOKEN_LIST_PAGING_ERROR(70012,"query access token list paging error", "查询访问token列表错误"),
