...
public enum Status {
    ...
    WORKER_GROUP_NOT_EXISTS(50060, "task definition [{0}] Worker group [{1}] not exists", "任务定义[{0}]中Worker工作组[{1}]不存在"),
    WORKER_GROUP_NOT_EXISTS_PROCESSING(50061, "process instance [{0}] Worker group [{1}] not exists", "工作流实例[{0}]中Worker工作组[{1}]不存在"),
