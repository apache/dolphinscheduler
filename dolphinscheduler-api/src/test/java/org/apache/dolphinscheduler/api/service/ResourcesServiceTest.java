...
public class ResourcesServiceTest {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger(ResourcesServiceImpl.class);
...
//        PowerMockito.mockStatic(HadoopUtils.class);
    ...
    public void testCreateResource() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FILE_CREATE.getKey(), serviceLogger)).thenReturn(true);
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.UDF_CREATE_FOLDER.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, null, 1, serviceLogger)).thenReturn(true);
    ...
    public void testCreateDirecotry() {
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FOLDER_CREATE.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, null, 1, serviceLogger)).thenReturn(true);
    ...
    public void testUpdateResource() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FILE_EDIT.getKey(), serviceLogger)).thenReturn(true);
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 2, FuncPermissionEnum.FILE_EDIT.getKey(), serviceLogger)).thenReturn(true);
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.UDF_FUNC_EDIT.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, new Object[]{1}, 1, serviceLogger)).thenReturn(true);
        try {
    ...
    public void testQueryResourceListPaging() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FILE_VIEW.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, null, 1, serviceLogger)).thenReturn(true);
    ...
    public void testQueryResourceList() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 0, FuncPermissionEnum.FILE_VIEW.getKey(), serviceLogger)).thenReturn(true);
        ...
        // test udf
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 0, FuncPermissionEnum.UDF_FILE_VIEW.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, null, 0, serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.userOwnedResourceIdsAcquisition(AuthorizationType.RESOURCE_FILE_ID, 0, serviceLogger)).thenReturn(getSetIds());
    ...
    public void testDelete() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 0, FuncPermissionEnum.FILE_DELETE.getKey(), serviceLogger)).thenReturn(true);
    ...
    public void testOnlineCreateResource() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FILE_UPLOAD.getKey(), serviceLogger)).thenReturn(true);
        PowerMockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.RESOURCE_FILE_ID, null, 1, serviceLogger)).thenReturn(true);
    ...
    public void testDownloadResource() {
        ...
        PowerMockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.RESOURCE_FILE_ID, 1, FuncPermissionEnum.FILE_DOWNLOAD.getKey(), serviceLogger)).thenReturn(true);
