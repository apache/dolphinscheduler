...
public class ProjectServiceTest {
    ...
    public void testCreateProject() {
        ...
        loginUser.setId(1);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.PROJECTS, loginUser.getId(), FuncPermissionEnum.CREATE_PROJECT.toString(), baseServiceLogger)).thenReturn(true);
...
//        Mockito.when(projectUserMapper.queryProjectRelation(1, 1)).thenReturn(getProjectUser());
        ...
        Map<String, Object> result = projectService.checkProjectAndAuth(loginUser, null, projectCode, FuncPermissionEnum.PROJECT.toString());
        logger.info(result.toString());
        ...
        project.setUserId(2);
        result = projectService.checkProjectAndAuth(loginUser, project, projectCode,FuncPermissionEnum.PROJECT.toString());
        logger.info(result.toString());
        ...
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.PROJECTS, project.getUserId(), FuncPermissionEnum.PROJECT.toString(), baseServiceLogger)).thenReturn(true);
        ...
        result2 = projectService.checkProjectAndAuth(loginUser, null, projectCode,FuncPermissionEnum.PROJECT.toString());
        ...
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.PROJECTS, loginUser.getId(), FuncPermissionEnum.PROJECT.toString(), baseServiceLogger)).thenReturn(true);
//        Mockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.PROJECTS, new Object[]{project.getId()}, 0, baseServiceLogger)).thenReturn(true);
        result2 = projectService.checkProjectAndAuth(loginUser, project1, projectCode,FuncPermissionEnum.PROJECT.toString());
        Assert.assertEquals(Status.USER_NO_OPERATION_PROJECT_PERM, result2.get(Constants.STATUS));

        //success
        project1.setUserId(1);
        projectService.checkProjectAndAuth(loginUser, project1, projectCode,FuncPermissionEnum.PROJECT.toString());
...
//        }
    ...
    public void testDeleteProject() {
        ...
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.PROJECTS, loginUser.getId(), FuncPermissionEnum.DELETE_PROJECT.toString(), baseServiceLogger)).thenReturn(true);
        //PROJECT_NOT_FOUNT
    ...
    public void testUpdate() {
        ...
        Project project = getProject();
        project.setCode(2L);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.PROJECTS, loginUser.getId(), FuncPermissionEnum.EDIT_PROJECT.toString(), baseServiceLogger)).thenReturn(true);
        Mockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.PROJECTS, new Object[]{1},loginUser.getId() , baseServiceLogger)).thenReturn(true);
   ...
   //     Mockito.when(projectMapper.queryProjectCreatedAndAuthorizedByUserId(1)).thenReturn(getList());
        Mockito.when(resourcePermissionCheckService.userOwnedResourceIdsAcquisition(AuthorizationType.PROJECTS, loginUser.getId(), projectLogger)).thenReturn(set);
        Mockito.when(projectMapper.listAuthorizedProjects(loginUser.getUserType().equals(UserType.ADMIN_USER) ? 0 : loginUser.getId(),new Object[]{1})).thenReturn(getList());
