...
public class ProcessDefinitionServiceTest {
    ...
    public void testQueryProcessDefinitionByCode() {
        ...
        Mockito.when(processService.genDagData(Mockito.any(), Mockito.anyBoolean())).thenReturn(dagData);

        Map<String, Object> instanceNotexitRes = processDefinitionService.queryProcessDefinitionByCode(loginUser, projectCode, 1L, false);
