...
public class AlertGroupServiceTest {
    ...
    public void testListPaging() {
        ...
        user.setId(1);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.ALERT_GROUP, 1, FuncPermissionEnum.ALARM_GROUP_MANAGE.toString(), baseServiceLogger)).thenReturn(true);
    ...
    public void testCreateAlertgroup() {
        ...
        user.setId(1);
        //success
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.ALERT_GROUP, 1, FuncPermissionEnum.CREATE_ALARM_GROUP.toString().toString(), baseServiceLogger)).thenReturn(true);
        Mockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.ALERT_GROUP, null, 0, baseServiceLogger)).thenReturn(true);
    ...
    public void testCreateAlertgroupDuplicate() {
        ...
        user.setUserType(UserType.ADMIN_USER);
        user.setId(1);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.ALERT_GROUP, 1, FuncPermissionEnum.CREATE_ALARM_GROUP.toString(), baseServiceLogger)).thenReturn(true);
        Mockito.when(resourcePermissionCheckService.resourcePermissionCheck(AuthorizationType.ALERT_GROUP, null, 0, baseServiceLogger)).thenReturn(true);
        Map<String, Object> result = alertGroupService.createAlertgroup(user, groupName, groupName, null);
        logger.info(result.toString());
    ...
    public void testUpdateAlertgroup() {
        ...
        // not exist
        user.setUserType(UserType.ADMIN_USER);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.ALERT_GROUP, user.getId(), FuncPermissionEnum.ALERT_GROUP_EDIT.toString(), baseServiceLogger)).thenReturn(true);
    ...
    public void testDelAlertgroupById() {
        ...
        // no operate
        user.setUserType(UserType.GENERAL_USER);
        Mockito.when(resourcePermissionCheckService.operationPermissionCheck(AuthorizationType.ALERT_GROUP, user.getId(), FuncPermissionEnum.ALERT_GROUP_DELETE.toString(), baseServiceLogger)).thenReturn(true);
