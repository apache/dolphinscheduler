...
public class TaskDefinitionServiceImplTest {
    ...
    public void deleteTaskDefinitionByCode() {
        ...
        // success
        Mockito.doNothing().when(projectService).hasProjectAndPerm(user, project,
    ...
    public void switchVersion() {
        ...
        putMsg(result, Status.SUCCESS, PROJECT_CODE);
        Mockito.doNothing().when(projectService).hasProjectAndPerm(user, getProject(),
                any());
    ...
    public void testCreateTaskDefinitionV2() {
        ...
        Mockito.doThrow(new ServiceException(Status.PROJECT_NOT_FOUND)).when(projectService)
                .hasProjectAndPerm(user, getProject(), TASK_DEFINITION_CREATE);
        exception = Assertions.assertThrows(ServiceException.class,
                () -> taskDefinitionService.createTaskDefinitionV2(user, taskCreateRequest));
    ...
    public void testUpdateTaskDefinitionV2() {
        ...
        Mockito.doThrow(new ServiceException(Status.PROJECT_NOT_FOUND)).when(projectService)
                .hasProjectAndPerm(user, getProject(), TASK_DEFINITION_UPDATE);
        exception = Assertions.assertThrows(ServiceException.class,
                () -> taskDefinitionService.updateTaskDefinitionV2(user, TASK_CODE, taskUpdateRequest));
        Assertions.assertEquals(Status.PROJECT_NOT_FOUND.getCode(), ((ServiceException) exception).getCode());
    ...
    public void testGetTaskDefinition() {
        ...
        Mockito.doThrow(new ServiceException(Status.USER_NO_OPERATION_PROJECT_PERM)).when(projectService)
                .hasProjectAndPerm(user, getProject(), TASK_DEFINITION);
        exception = Assertions.assertThrows(ServiceException.class,
                () -> taskDefinitionService.getTaskDefinition(user, TASK_CODE));
        ...
        // success
        Mockito.doNothing().when(projectService).hasProjectAndPerm(user, getProject(), TASK_DEFINITION);
