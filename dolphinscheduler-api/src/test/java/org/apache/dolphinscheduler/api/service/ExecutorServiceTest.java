...
public class ExecutorServiceTest {
    ...
    public void testNoComplement() {
        ...
        Map<String, Object> result = executorService.execProcessInstance(loginUser, projectCode,
                ...
                Priority.LOW, Constants.DEFAULT_WORKER_GROUP, 100L, 10, null, 0, 0);
    ...
    public void testComplementWithStartNodeList() {
        ...
        Map<String, Object> result = executorService.execProcessInstance(loginUser, projectCode,
                ...
                null, null, 0,
                RunMode.RUN_MODE_SERIAL,
                Priority.LOW, Constants.DEFAULT_WORKER_GROUP, 100L,110, null, 0, 0);
        Assert.assertEquals(Status.SUCCESS, result.get(Constants.STATUS));
        verify(processService, times(1)).createCommand(any(Command.class));
    ...
    public void testParallelWithSchedule() {
        ...
        Map<String, Object> result = executorService.execProcessInstance(loginUser, projectCode,
                ...
                null, null, 0,
                RunMode.RUN_MODE_PARALLEL,
                Priority.LOW, Constants.DEFAULT_WORKER_GROUP, 100L,110, null, 15, 0);
        Assert.assertEquals(Status.SUCCESS, result.get(Constants.STATUS));
