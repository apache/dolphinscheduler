...
public class TaskInstanceServiceTest {
    ...
    public void queryTaskListPaging() {
        ...
        when(projectService.checkProjectAndAuth(loginUser, project, projectCode, FuncPermissionEnum.TASK_INSTANCE.toString())).thenReturn(result);
    ...
    public void forceTaskSuccess() {
        ...
        when(projectService.checkProjectAndAuth(user, project, projectCode,FuncPermissionEnum.FORCED_SUCCESS.toString())).thenReturn(mockFailure);
        ...
        // test task not found
        when(projectService.checkProjectAndAuth(user, project, projectCode,FuncPermissionEnum.FORCED_SUCCESS.toString())).thenReturn(mockSuccess);
        ...
        putMsg(result, Status.SUCCESS, projectCode);
        when(projectMapper.queryByCode(projectCode)).thenReturn(project);
        when(projectService.checkProjectAndAuth(user, project, projectCode,FuncPermissionEnum.FORCED_SUCCESS.toString())).thenReturn(result);
