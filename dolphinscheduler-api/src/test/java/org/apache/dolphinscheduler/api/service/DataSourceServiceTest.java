...
public class DataSourceServiceTest {
    ...
    public void createDataSourceTest() {
        ...
        postgreSqlDatasourceParam.setHost("realtime-1");
        postgreSqlDatasourceParam.setPort(21050);
        postgreSqlDatasourceParam.setDatabase("zanalytics");
        postgreSqlDatasourceParam.setUserName("admin");
        postgreSqlDatasourceParam.setPassword("admin");
