...
public class LoggerControllerStreamingTest {
    ...
    public void downloadTaskLog_success_streamsOctetStreamWithAttachmentHeader() throws Exception {
        ...
        // StreamingResponseBody writes on the ASYNC thread, so the initial perform() only
        // starts the async processing — the body is not guaranteed to exist yet. Assert
        // asyncStarted, then assert the FINAL response through asyncDispatch.
