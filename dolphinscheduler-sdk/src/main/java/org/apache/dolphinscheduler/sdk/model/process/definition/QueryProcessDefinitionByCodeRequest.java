...
public class QueryProcessDefinitionByCodeRequest extends TeaModel {
    @NameInMap(value = "path")
    @Validation(required = true)
    public Path path;

    public static QueryProcessDefinitionByCodeRequest build(java.util.Map<String, ?> map) throws Exception {
        QueryProcessDefinitionByCodeRequest self = new QueryProcessDefinitionByCodeRequest();
