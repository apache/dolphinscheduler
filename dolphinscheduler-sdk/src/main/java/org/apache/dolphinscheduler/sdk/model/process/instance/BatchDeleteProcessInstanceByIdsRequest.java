...
public class BatchDeleteProcessInstanceByIdsRequest extends TeaModel {
    ...
    public static class Query extends TeaModel {
        /**
         * processInstanceId 列表, 逗号分隔
         */
        @NameInMap(value = "processInstanceIds")
        @Validation(required = true)
    ...
    public static BatchDeleteProcessInstanceByIdsRequest build(java.util.Map<String, ?> map) throws Exception {
        BatchDeleteProcessInstanceByIdsRequest self = new BatchDeleteProcessInstanceByIdsRequest();
        return TeaModel.build(map, self);
    }
}
