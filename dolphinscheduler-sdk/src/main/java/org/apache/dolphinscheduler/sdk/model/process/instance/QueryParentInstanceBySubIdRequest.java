...
public class QueryParentInstanceBySubIdRequest extends TeaModel {
    ...
    public static QueryParentInstanceBySubIdRequest build(java.util.Map<String, ?> map) throws Exception {
        QueryParentInstanceBySubIdRequest self = new QueryParentInstanceBySubIdRequest();
        return TeaModel.build(map, self);
    }
}
