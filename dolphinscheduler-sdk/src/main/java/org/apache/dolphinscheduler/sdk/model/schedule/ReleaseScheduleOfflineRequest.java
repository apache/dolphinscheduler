 ...
 */
public class ReleaseScheduleOfflineRequest extends TeaModel {
    @NameInMap(value = "path")
    @Validation(required = true)
    public ReleaseScheduleOfflineRequest.Path path;
    ...
    public static class Path extends TeaModel {
        ...
        public static ReleaseScheduleOfflineRequest.Path build(Map<String, ?> map) throws Exception {
            ReleaseScheduleOfflineRequest.Path self = new ReleaseScheduleOfflineRequest.Path();
