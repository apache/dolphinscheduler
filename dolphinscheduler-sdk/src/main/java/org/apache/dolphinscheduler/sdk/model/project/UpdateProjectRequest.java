...
public class UpdateProjectRequest extends TeaModel {
    ...
    public UpdateProjectRequest.Path path = new UpdateProjectRequest.Path();

    @NameInMap(value = "query")
    @Validation(required = true)
    public UpdateProjectRequest.Query query = new UpdateProjectRequest.Query();
