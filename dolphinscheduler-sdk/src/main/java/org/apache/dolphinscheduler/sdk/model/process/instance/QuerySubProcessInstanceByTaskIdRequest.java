...
public class QuerySubProcessInstanceByTaskIdRequest extends TeaModel {
    ...
    public static QuerySubProcessInstanceByTaskIdRequest build(java.util.Map<String, ?> map) throws Exception {
        QuerySubProcessInstanceByTaskIdRequest self = new QuerySubProcessInstanceByTaskIdRequest();
        return TeaModel.build(map, self);
    }
}
