...
package org.apache.dolphinscheduler.sdk.model.queue;
...
public class QueryQueueListPagingRequest extends TeaModel {
    @NameInMap(value = "query")
    @Validation(required = true)
    public QueryQueueListPagingRequest.Query query = new QueryQueueListPagingRequest.Query();
