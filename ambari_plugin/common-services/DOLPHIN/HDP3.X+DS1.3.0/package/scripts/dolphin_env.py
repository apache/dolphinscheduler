...
def dolphin_env():
    ...
    File(format(params.dolphin_conf_dir + "/worker_logback.xml"),
         mode=0755,
         content=Template("worker_logback.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/master_logback.xml"),
         mode=0755,
         content=Template("master_logback.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/apiserver_logback.xml"),
         mode=0755,
         content=Template("apiserver_logback.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )

    File(format(params.dolphin_conf_dir + "/alert_logback.xml"),
         mode=0755,
         content=Template("alert_logback.xml.j2"),
         owner=params.dolphin_user,
         group=params.dolphin_group
         )