...
public class ProcessServiceTest {
    ...
    public void testChangeJson() {
        ...
        String expected = "{\"tasks\":[{\"id\":\"tasks-82223\",\"name\":\"testa\",\"desc\":null,\"type\":\"SHELL\",\"runFlag\""
            ...
            + ":null,\"timeout\":{\"strategy\":\"\",\"interval\":null,\"enable\":false},\"conditionsParameters\":null,\"delayTime\":0},{\"id\""
            + ":\"tasks-88338\",\"name\":\"testbchange\",\"desc\":null,\"type\":\"SHELL\",\"runFlag\":\"NORMAL\",\"loc\""
            ...
            + ":{\"successNode\":[\"\"],\"failedNode\":[\"\"]},\"taskInstancePriority\":\"MEDIUM\",\"workerGroup\":\"default\",\"workerGroupId\""
            + ":null,\"timeout\":{\"strategy\":\"\",\"interval\":null,\"enable\":false},\"conditionsParameters\":null,\"delayTime\":0},{\"id\""
            + ":\"tasks-91388\",\"name\":\"testc\",\"desc\":null,\"type\":\"SHELL\",\"runFlag\":\"NORMAL\",\"loc\":null,\"maxRetryTimes\""
            + ":0,\"retryInterval\":1,\"params\":{\"resourceList\":[],\"localParams\":[],\"rawScript\":\"testc\"},\"preTasks\""
            + ":[\"branch\"],\"extras\":null,\"depList\":[\"branch\"],\"dependence\":{},\"conditionResult\":{\"successNode\""
            + ":[\"\"],\"failedNode\":[\"\"]},\"taskInstancePriority\":\"MEDIUM\",\"workerGroup\":\"default\",\"workerGroupId\""
            + ":null,\"timeout\":{\"strategy\":\"\",\"interval\":null,\"enable\":false},\"conditionsParameters\":null,\"delayTime\""
            + ":0},{\"id\":\"tasks-77673\",\"name\":\"branch\",\"desc\":null,\"type\":\"CONDITIONS\",\"runFlag\":\"NORMAL\",\"loc\""
            + ":null,\"maxRetryTimes\":0,\"retryInterval\":1,\"params\":{},\"preTasks\":[\"testa\"],\"extras\":null,\"depList\""
            + ":[\"testa\"],\"dependence\":{\"relation\":\"AND\",\"dependTaskList\":[]},\"conditionResult\":{\"successNode\""
            + ": [\"testbchange\"],\"failedNode\": [\"testc\"]},\"taskInstancePriority\":\"MEDIUM\",\"workerGroup\":\"default\",\"workerGroupId\""
            + ":null,\"timeout\":{\"strategy\":\"\",\"interval\":null,\"enable\":false},\"conditionsParameters\":null,\"delayTime\":0}],\"globalParams\""
            + ":[],\"timeout\":0,\"tenantId\":0}";
