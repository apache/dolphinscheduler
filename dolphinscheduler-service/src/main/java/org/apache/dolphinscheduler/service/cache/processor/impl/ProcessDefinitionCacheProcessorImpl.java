...
public class ProcessDefinitionCacheProcessorImpl implements ProcessDefinitionCacheProcessor {
    ...
    @Override
    @Cacheable(sync = true)
    public ProcessDefinition queryByCode(long processDefinitionCode) {
        return processDefineMapper.queryByCode(processDefinitionCode);
    }

    @Override
    @Cacheable(sync = true, key = "#processDefinitionCode + '_' + #version")
    public ProcessDefinition queryByDefinitionCodeAndVersion(long processDefinitionCode, int version) {
        return processDefineLogMapper.queryByDefinitionCodeAndVersion(processDefinitionCode, version);
    }
