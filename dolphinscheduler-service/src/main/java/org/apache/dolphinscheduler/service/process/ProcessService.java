...
public class ProcessService {
    ...
    private void setTaskFromTaskNode(TaskNode taskNode, TaskDefinition taskDefinition) {
        ...
        taskDefinition.setTaskParams(TaskType.DEPENDENT.getDesc().equalsIgnoreCase(taskNode.getType())
                                     || TaskType.CONDITIONS.getDesc().equalsIgnoreCase(
                                         taskNode.getType()) ? taskNode.getDependence() : taskNode.getParams());
    ...
    public List<TaskNode> genTaskNodeList(Long processCode, int processVersion, Map<String, String> locationMap) {
        ...
        taskNodeMap.forEach((k, v) -> {
            ...
            v.setDependence(TaskType.DEPENDENT.getDesc().equalsIgnoreCase(taskDefinitionLog.getTaskType())
                            || TaskType.CONDITIONS.getDesc().equalsIgnoreCase(
                                taskDefinitionLog.getTaskType()) ? taskDefinitionLog.getTaskParams() : null);
