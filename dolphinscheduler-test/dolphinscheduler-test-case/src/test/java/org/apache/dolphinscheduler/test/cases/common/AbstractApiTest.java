...
import org.apache.dolphinscheduler.test.endpoint.EndPointFactory;
...
import org.apache.dolphinscheduler.test.endpoint.base.TestLifecycleLogger;
...
public abstract class AbstractApiTest implements TestLifecycleLogger {
    ...
    protected void initEndPointFactory() {
        endPointFactory = new EndPointFactory(request, reqSpec, sessionId);
    }
}
