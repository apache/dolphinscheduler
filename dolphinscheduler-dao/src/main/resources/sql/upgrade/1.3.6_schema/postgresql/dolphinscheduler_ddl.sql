...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_worker_group_A_ip_list() RETURNS void AS $$
BEGIN
    IF
...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_qrtz_fired_triggers_A_entry_id() RETURNS void AS $$
BEGIN
    IF
EXISTS (SELECT 1 FROM information_schema.COLUMNS
