...
(
    11
) NOT NULL AUTO_INCREMENT COMMENT 'key',
    `user_id` int
(
    11
...
(
    4
) NULL DEFAULT NULL COMMENT 'command type',
    `executor_id` int
(
    11
) NULL DEFAULT NULL COMMENT 'executor id',
    `process_definition_id` int
(
    11
) NULL DEFAULT NULL COMMENT 'process definition id',
...
(
    4
) NULL DEFAULT NULL COMMENT 'task depend type',
    `failure_strategy` tinyint
(
    4
) NULL DEFAULT 0 COMMENT 'failure strategy',
    `warning_type` tinyint
(
    4
) NULL DEFAULT 0 COMMENT 'warning type',
    `warning_group_id` int
(
    11
) NULL DEFAULT NULL COMMENT 'warning group id',
    ...
    `process_instance_priority` int
(
    11
) NULL DEFAULT NULL COMMENT 'process instance priority, 0 Highest,1 High,2 Medium,3 Low,4 Lowest',
    `worker_group_id` int
(
    11
) NULL DEFAULT -1 COMMENT 'worker group id',
...
(
    256
) NULL DEFAULT NULL COMMENT 'worker group name',
    `ip_list` varchar
(
    256
) NULL DEFAULT NULL COMMENT 'worker ip list. split by [,] ',
