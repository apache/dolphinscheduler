...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_datasource_A_note() RETURNS void AS $$
BEGIN
    IF
...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_resources_A_description() RETURNS void AS $$
BEGIN
    IF
EXISTS (SELECT 1 FROM information_schema.COLUMNS
...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_schedules_A_crontab() RETURNS void AS $$
BEGIN
    IF
EXISTS (SELECT 1 FROM information_schema.COLUMNS
...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_tenant_A_description() RETURNS void AS $$
BEGIN
    IF
EXISTS (SELECT 1 FROM information_schema.COLUMNS
...
d//
CREATE
OR REPLACE FUNCTION uc_dolphin_T_t_ds_worker_group_A_name() RETURNS void AS $$
BEGIN
    IF
EXISTS (SELECT 1 FROM information_schema.COLUMNS
