...
CREATE
    TABLE
        ` t_ds_alertgroup `(
            ...
            UNIQUE KEY ` t_ds_alertgroup_name_un `(
                ` group_name `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
CREATE
    TABLE
        ` t_ds_datasource `(
            ...
            UNIQUE KEY ` t_ds_datasource_name_un `(
                ` name `,
                ` TYPE `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS ` t_ds_process_definition `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_process_definition_log `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_task_definition `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_task_definition_log `;
...
CREATE
    TABLE
        ` t_ds_task_definition_log `(
            ...
            KEY ` idx_code_version `(
                ` code `,
                ` version `
            ),
            KEY ` idx_project_code `(
                ` project_code `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS ` t_ds_process_task_relation `;
...
CREATE
    TABLE
        ` t_ds_process_task_relation `(
            ...
            KEY ` idx_pre_task_code_version `(
                ` pre_task_code `,
                ` pre_task_version `
            ),
            KEY ` idx_post_task_code_version `(
                ` post_task_code `,
                ` post_task_version `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS ` t_ds_process_task_relation_log `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_process_instance `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_datasource_user `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_process_instance `;
...
CREATE
    TABLE
        ` t_ds_relation_process_instance `(
            ...
            KEY ` idx_parent_process_task `(
                ` parent_process_instance_id `,
                ` parent_task_instance_id `
            ),
            KEY ` idx_process_instance_id `(
                ` process_instance_id `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_project_user `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_resources_user `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_udfs_user `;
    ...
    TABLE
        ` t_ds_plugin_define `(
            ...
            UPDATE
                ...
                UNIQUE KEY ` t_ds_plugin_define_UN `(
                    ` plugin_name `,
                    ` plugin_type `
                )
...
DROP
    TABLE
        IF EXISTS ` t_ds_alert_plugin_instance `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_dq_comparison_type `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_dq_execute_result `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_dq_rule_execute_sql `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_dq_rule_input_entry `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_dq_task_statistics_value `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_rule_execute_sql `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_rule_input_entry `;
    ...
    TABLE
        ` t_ds_environment `(
            ...
            UPDATE
                ...
                UNIQUE KEY ` environment_name_unique `(
                    ` name `
                ),
                UNIQUE KEY ` environment_code_unique `(
                    ` code `
                )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS ` t_ds_environment_worker_group_relation `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_task_group_queue `;
...
DROP
    TABLE
        IF EXISTS ` t_ds_relation_namespace_user `;
...
CREATE
    TABLE
        ` t_ds_relation_namespace_user `(
            ...
            UNIQUE KEY ` namespace_user_unique `(
                ` user_id `,
                ` namespace_id `
            )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
...
DROP
    TABLE
        IF EXISTS t_ds_alert_send_status;
...
CREATE
    TABLE
        t_ds_alert_send_status(
            ...
            UNIQUE KEY ` alert_send_status_unique `(
                ` alert_id `,
    ...
    TABLE
        ` t_ds_cluster `(
            ...
            UPDATE
                ...
                UNIQUE KEY ` cluster_name_unique `(
                    ` name `
                ),
                UNIQUE KEY ` cluster_code_unique `(
                    ` code `
                )
        ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8;
