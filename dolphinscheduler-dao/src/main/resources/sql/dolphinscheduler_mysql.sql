...
CREATE TABLE `t_ds_alert` (
  ...
  `warning_type` tinyint(4) DEFAULT '2' COMMENT '1 workflow is successfully, 2 workflow/task is failed, 3 workflow/task is timeout',
...
CREATE TABLE `t_ds_command` (
  ...
  `warning_type`              varchar(64) DEFAULT NULL COMMENT 'comma-separated codes like 1,2,3 (1=SUCCESS,2=FAILURE,3=TIMEOUT)',
