...
@Repository
public class TaskRemoteHostDaoImpl implements TaskRemoteHostDao {

    @Autowired
    private TaskRemoteHostMapper taskRemoteHostMapper;

    @Override
    public TaskRemoteHost getTaskRemoteHostByCode(Long code) {
        return taskRemoteHostMapper.queryByTaskRemoteHostCode(code);
    }
}
