...
import org.apache.dolphinscheduler.dao.provider.DataSourceClientProvider;
...
public class DatasourceUtil {
    ...
    private static final Map<String, DataSourceClient> dataSourceClientMap = new ConcurrentHashMap<>();
    ...
    /**
     * spi create datasource client plugin
     */
    public static Connection getConnection(DbType dbType, ConnectionParam connectionParam) {
        ...
        logger.info("createDataSourceClient datasourceUniqueId {}", datasourceUniqueId);
        dataSourceClient = dataSourceClientMap.get(datasourceUniqueId);
        if (dataSourceClient == null) {
            dataSourceClient = DataSourceClientProvider.createDataSourceClient(baseConnectionParam, dbType);
            dataSourceClientMap.put(datasourceUniqueId, dataSourceClient);
        }
