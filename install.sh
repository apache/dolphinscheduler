...
sed -i ${txt} "s#spring.datasource.url.*#spring.datasource.url=jdbc:${dbtype}://${dbhost}/${dbname}?stringtype=unspecified\&characterEncoding=UTF-8\&allowMultiQueries=true#g" conf/datasource.properties
