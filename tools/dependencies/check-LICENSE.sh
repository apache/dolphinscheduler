...
echo '=== Skywalking agent dependencies: ' && ls dist/skywalking-agent/plugins | tee -a all-dependencies.txt && ls dist/skywalking-agent/activations | tee -a all-dependencies.txt
