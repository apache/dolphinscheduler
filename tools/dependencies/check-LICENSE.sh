...
echo '=== Skywalking agent dependencies: ' && ls ./skywalking-agent | grep .jar | tee -a all-dependencies.txt \
  && ls ./skywalking-agent/plugins | tee -a all-dependencies.txt \
  && ls ./skywalking-agent/activations | tee -a all-dependencies.txt
