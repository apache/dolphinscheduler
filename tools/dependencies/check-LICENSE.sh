...
echo '=== Skywalking agent dependencies: ' && ls dist/ext/skywalking-agent | grep .jar | tee -a all-dependencies.txt \
  && ls dist/ext/skywalking-agent/plugins | tee -a all-dependencies.txt \
  && ls dist/ext/skywalking-agent/activations | tee -a all-dependencies.txt
