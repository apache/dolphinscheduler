...
@NoArgsConstructor
public class TaskExecutorResultAlertLifecycleEvent extends AbstractTaskExecutorLifecycleEvent
        implements
    ...
    public static TaskExecutorResultAlertLifecycleEvent of(final ITaskExecutor taskExecutor,
                                                           TaskResultAlertInfo taskResultAlertInfo) {
        final TaskExecutionContext taskExecutionContext = taskExecutor.getTaskExecutionContext();
        return TaskExecutorResultAlertLifecycleEvent.builder()
                ...
                .taskResultAlertInfo(taskResultAlertInfo)
                .type(TaskExecutorLifecycleEventType.RESULT_ALERT)
                .build();
    }
