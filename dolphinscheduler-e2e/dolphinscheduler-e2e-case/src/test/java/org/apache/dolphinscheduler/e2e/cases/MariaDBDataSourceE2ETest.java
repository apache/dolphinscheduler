...
@DolphinScheduler(composeFiles = "docker/datasource-mariadb/docker-compose.yaml")
@DisableIfTestFails
public class MariaDBDataSourceE2ETest {
    ...
    private static final String dataSourceType = "MARIADB";

    private static final String dataSourceName = "mariadb_test";

    private static final String dataSourceDescription = "mariadb_test";

    private static final String ip = "mariadb";

    private static final String port = "3306";

    private static final String userName = "root";

    private static final String mariadbPassword = "123456";

    private static final String database = "mariadb_test";
    ...
    @Test
    @Order(10)
    void testCreateMariaDBDataSource() {
    ...
    @Test
    @Order(20)
    void testDeleteMariaDBDataSource() {
        final DataSourcePage page = new DataSourcePage(browser);
