...
import org.apache.dolphinscheduler.server.master.runner.PriorityDelayITaskExecutionRunnable;
...
public class PriorityDelayITaskExecutionRunnableTest {
    ...
    public void testCompareTo() {
        ...
        TaskExecutionRunnableContext taskExecutionRunnableContext1 = TaskExecutionRunnableContext.builder()
                .workflowInstance(workflowInstance)
                .taskInstance(t1)
                .taskExecutionContext(context1)
                .build();

        TaskExecutionRunnableContext taskExecutionRunnableContext2 = TaskExecutionRunnableContext.builder()
                .workflowInstance(workflowInstance)
                .taskInstance(t2)
                .taskExecutionContext(context2)
                .build();
        PriorityDelayITaskExecutionRunnable p1 =
                new TaskExecutionRunnable(taskExecutionRunnableContext1, taskOperatorManager);
        PriorityDelayITaskExecutionRunnable p2 =
                new TaskExecutionRunnable(taskExecutionRunnableContext2, taskOperatorManager);
