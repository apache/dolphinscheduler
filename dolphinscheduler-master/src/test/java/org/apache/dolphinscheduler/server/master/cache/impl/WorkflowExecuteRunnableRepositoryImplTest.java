...
public class WorkflowExecuteRunnableRepositoryImplTest {

    @InjectMocks
    private WorkflowExecuteRunnableRepositoryImpl processInstanceExecCacheManager;

    @Mock
    private IWorkflowExecutionRunnable workflowExecuteThread;
    ...
    public void testGetByProcessInstanceId() {
        IWorkflowExecutionRunnable workflowExecuteThread =
                processInstanceExecCacheManager.getByProcessInstanceId(1);
    ...
    public void testCacheNull() {
        ...
        IWorkflowExecutionRunnable workflowExecuteThread =
                processInstanceExecCacheManager.getByProcessInstanceId(2);
    ...
    public void testGetAll() {
        Collection<IWorkflowExecutionRunnable> workflowExecuteThreads = processInstanceExecCacheManager.getAll();
