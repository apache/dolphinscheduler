...
public class WorkflowExecuteRunnableFactory {
    ...
    public Optional<WorkflowExecutionRunnable> createWorkflowExecuteRunnable(Command command) throws WorkflowCreateException {
        try {
            Optional<IWorkflowExecutionContext> workflowExecuteRunnableContextOptional =
                    workflowExecuteContextFactory.createWorkflowExecuteRunnableContext(command);
            return workflowExecuteRunnableContextOptional
                    .map(iWorkflowExecuteContext -> new WorkflowExecutionRunnable(
