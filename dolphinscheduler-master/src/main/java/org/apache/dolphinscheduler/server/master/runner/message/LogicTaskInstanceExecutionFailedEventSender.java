...
@Component
public class LogicTaskInstanceExecutionFailedEventSender
        implements
            LogicTaskInstanceExecutionEventSender<TaskExecutionFailedEvent> {
    ...
    @Override
    public TaskExecutionFailedEvent buildMessage(final TaskExecutionContext taskExecutionContext) {
