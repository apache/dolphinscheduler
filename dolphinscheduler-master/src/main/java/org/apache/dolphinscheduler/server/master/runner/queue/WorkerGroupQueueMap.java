...
public class WorkerGroupQueueMap {
    ...
    private final Map<String, DelayQueue<PriorityDelayEntry<ITaskExecutionRunnable>>> queueMap = new HashMap<>();
    ...
    public void add(String workerGroup, ITaskExecutionRunnable taskExecutionRunnable, long delayTimeMills) {
        queueMap.computeIfAbsent(workerGroup, k -> new DelayQueue<>())
                .add(new PriorityDelayEntry<>(delayTimeMills, taskExecutionRunnable));
        ...
        for (Map.Entry<String, DelayQueue<PriorityDelayEntry<ITaskExecutionRunnable>>> entry : queueMap.entrySet()) {
            ...
            if (priorityDelayEntry != null) {
                ...
                if (taskExecutionRunnable != null) {
                    taskExecutionRunnablesMap.put(workerGroup, taskExecutionRunnable);
                }
            }
        }
