...
public interface IWorkflowExecuteRunnableRepository {
     ...
     */
    IWorkflowExecutionRunnable getByProcessInstanceId(int processInstanceId);
     ...
     */
    void cache(int processInstanceId, IWorkflowExecutionRunnable workflowExecuteThread);
