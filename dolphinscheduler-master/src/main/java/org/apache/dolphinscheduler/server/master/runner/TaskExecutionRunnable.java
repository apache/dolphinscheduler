...
public class TaskExecutionRunnable extends PriorityDelayITaskExecutionRunnable {

    private final TaskExecuteRunnableOperatorManager taskExecuteRunnableOperatorManager;

    public TaskExecutionRunnable(TaskExecutionRunnableContext taskExecutionRunnableContext,
