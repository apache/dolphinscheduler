...
| common.configmap.MANAGEMENT_SECURITY_PASSWORD | string | `"password"` | management endpoints security password |
| common.configmap.MANAGEMENT_SECURITY_USERNAME | string | `"username"` | management endpoints security username |
