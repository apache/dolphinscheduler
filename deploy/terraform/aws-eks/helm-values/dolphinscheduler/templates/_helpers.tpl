...
{{/*
Create a name for the master service account
*/}}
{{- define "dolphinscheduler.master.serviceAccountName" -}}
{{- if .Values.master.serviceAccount.name }}
  {{- .Values.master.serviceAccount.name -}}
{{- else }}
  {{- template "dolphinscheduler.fullname" . }}-sa
{{- end }}
{{- end }}

{{/*
Create a name for the worker service account
*/}}
{{- define "dolphinscheduler.worker.serviceAccountName" -}}
...
{{/*
Create a name for the alert service account
*/}}
{{- define "dolphinscheduler.alert.serviceAccountName" -}}
{{- if .Values.alert.serviceAccount.name }}
  {{- .Values.alert.serviceAccount.name -}}
{{- else }}
  {{- template "dolphinscheduler.fullname" . }}-sa
{{- end }}
{{- end }}
...
{{/*
Create a name for the api service account
*/}}
{{- define "dolphinscheduler.api.serviceAccountName" -}}
