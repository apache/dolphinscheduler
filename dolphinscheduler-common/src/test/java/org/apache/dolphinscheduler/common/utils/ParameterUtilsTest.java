...
public class ParameterUtilsTest {
    ...
    public void testConvertParameterPlaceholders2() {
        String parameterString = "${user} is userName,'$[yyMMdd]', '$[1]' '$[yyyyMMdd]'";
        Map<String, String> parameterMap = new HashMap<>();
        parameterMap.put("user", "Kris");
        parameterMap.put(Constants.PARAMETER_DATETIME, "20191220145900");
        parameterString = ParameterUtils.convertParameterPlaceholders(parameterString, parameterMap);
        Assert.assertEquals("Kris is userName,'191220', '$[1]' '20191220'", parameterString);
    }
