...
public enum AuditObjectType {
    ...
    UDF_FOLDER(2003,2000, "UDP Folder", true),
    UDP_FILE(2004,2002, "UDP file", true),
    UDP_FUNCTION(2002,2000, "UDP function", true),
    TASK_GROUP(2002,2000, "Task group", true),
    TASK_GROUP_QUEUE(2002,2000, "Task group queue", true),
    ...
    ALARM_GROUP(4003,4000, "User", true),
    ALARM_INSTANCE(4004,4000, "User", true),
    WORKER_GROUP(4005,4000, "User", true),
    YARN_QUEUE(4006,4000, "User", true),
    ENVIRONMENT(4007,4000, "User", true),
    CLUSTER(4008,4000, "User", true),
    K8S_NAMESPACE(4009,4000, "User", true),
    TOKEN(4010,4000, "User", true),
    ;
    ...
    static {
        List<AuditObjectType> list = Arrays.stream(values()).sorted(Comparator.comparing(type-> type.parentCode)).collect(Collectors.toList());
