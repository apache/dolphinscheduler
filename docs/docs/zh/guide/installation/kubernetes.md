...
| `registryJdbc.hikariConfig.maximumPoolSize`                          | Default use same Dolphinscheduler's database if you don't change this value. If you set this value, Registry jdbc's database type will use it                                                          | `5`                                    |
| `registryJdbc.hikariConfig.connectionTimeout`                        | Default use same Dolphinscheduler's database if you don't change this value. If you set this value, Registry jdbc's database type will use it                                                          | `9000`                                 |
| `registryJdbc.hikariConfig.idleTimeout`                              | Default use same Dolphinscheduler's database if you don't change this value. If you set this value, Registry jdbc's database type will use it                                                          | `600000`                               |
