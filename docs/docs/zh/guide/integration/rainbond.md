...
如果想在 “Rainbond Cloud” 上一键部署 “DolphinScheduler”，可以按照以下步骤进行操作

- 打开 [DolphinScheduler 应用详情](https://hub.grapps.cn/marketplace/apps/647)

![DolphinScheduler应用详情](../../../../img/rainbond/store-detail.png)
...
![DolphinScheduler 版本](../../../../img/rainbond/versions-dolphinscheduler.png)
