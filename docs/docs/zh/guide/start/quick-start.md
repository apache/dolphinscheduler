...
* [standalone server](https://dolphinscheduler.apache.org/zh-cn/docs/3.3.0-alpha/guide/installation/standalone)
* [docker](https://dolphinscheduler.apache.org/zh-cn/docs/3.3.0-alpha/guide/start/docker)
