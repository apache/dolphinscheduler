...
After complete the installation, get the `docker-compose.yaml` file from [download page](https://dolphinscheduler.apache.org/en-us/download/3.3.1)
...
and you could find all environment variables in [all environment variables](https://github.com/apache/dolphinscheduler/blob/3.3.1/script/env/dolphinscheduler_env.sh) <!-- markdown-link-check-disable-line -->
