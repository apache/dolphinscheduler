...
Configure the file in the following path: `dolphinscheduler-common/src/main/resources/common.properties`：
...
After version 3.0.0-alpha, if you want to upload resources using HDFS or S3 from the Resource Center, you will need to configure the following path: `dolphinscheduler-common/src/main/resources/common.properties`. This can be found as follows.
