...
| Timeout       | Script execution timeout in seconds, default is `60`.       |
...
3.Exit code meanings: `0` means success, `124` means timeout, and other exit codes indicate script execution failure.
