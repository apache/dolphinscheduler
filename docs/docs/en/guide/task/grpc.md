...
| Protobuf Definition JSON | Used for creating tasks via API, generated from the above definition as [JSON Descriptor](https://github.com/protobufjs/protobuf.js/#using-json-descriptors)    |
