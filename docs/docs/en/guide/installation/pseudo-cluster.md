...
- Database: [PostgreSQL](https://www.postgresql.org/download/) (9.5+) or [MySQL](https://dev.mysql.com/downloads/mysql/) (5.7+), you can choose one of the two, such as MySQL requires JDBC Driver 8.0.33
