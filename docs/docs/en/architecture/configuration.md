...
| task.process.group.enabled                    | true                                             | whether to run local shell tasks in a dedicated process group by using setsid, only intended for Linux hosts with setsid available                                                                                                                                                                                                                                                                                                   |
