...
| k8s.client.pool.max.size                                                    | 10            | Maximum total client connections per Kubernetes cluster.                                                                                                                                                                                                                                                          |
| k8s.client.pool.min.idle                                                    | 2             | Minimum number of idle clients maintained per cluster.                                                                                                                                                                                                                                                            |
| k8s.client.pool.max.idle                                                    | 5             | Maximum number of idle clients allowed per cluster.                                                                                                                                                                                                                                                               |
| k8s.client.pool.max.wait.ms                                                 | 30000         | Maximum time in milliseconds to wait when borrowing a client if the pool is exhausted.                                                                                                                                                                                                                            |
| k8s.client.pool.idle.timeout.ms                                             | 600000        | Idle client timeout in milliseconds; expired idle clients are periodically cleaned up.                                                                                                                                                                                                                            |
