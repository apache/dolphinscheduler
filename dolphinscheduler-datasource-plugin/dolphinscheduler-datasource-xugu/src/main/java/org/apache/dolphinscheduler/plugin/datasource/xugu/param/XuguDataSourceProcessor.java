...
public class XuguDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        XuguDataSourceParamDTO dmDatasourceParam = (XuguDataSourceParamDTO) dataSourceParam;
        String address = String
                .format("%s%s:%s", DataSourceConstants.JDBC_XUGU, dmDatasourceParam.getHost(),
        ...
        xuguConnectionParam.setUser(dmDatasourceParam.getUserName());
        xuguConnectionParam.setPassword(PasswordUtils.encodePassword(dmDatasourceParam.getPassword()));
        xuguConnectionParam.setDriverClassName(getDatasourceDriver());
        xuguConnectionParam.setValidationQuery(getValidationQuery());
        xuguConnectionParam.setOther(dmDatasourceParam.getOther());
