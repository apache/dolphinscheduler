...
@Slf4j
public class AliyunAdbSparkClientWrapper implements AutoCloseable {
    ...
    /**
     * Constructs an AliyunAdbSparkClientWrapper instance.
     ...
     */
    public AliyunAdbSparkClientWrapper(String accessKeyId, String accessKeySecret, String regionId) throws Exception {
        ...
        aliyunAdbSparkClient = new Client(config);
    }
