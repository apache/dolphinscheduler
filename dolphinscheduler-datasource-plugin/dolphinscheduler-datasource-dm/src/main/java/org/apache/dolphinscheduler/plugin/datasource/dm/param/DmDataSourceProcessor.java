...
public class DmDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public BaseConnectionParam createConnectionParams(BaseDataSourceParamDTO dataSourceParam) {
        ...
        String address = String
            .format("%s%s:%s", DataSourceConstants.JDBC_DM, dmDatasourceParam.getHost(), dmDatasourceParam.getPort());
        String jdbcUrl = StringUtils.isEmpty(dmDatasourceParam.getDatabase()) ? address : String.format("%s/%s", address,
    ...
    public Connection getConnection(ConnectionParam connectionParam) throws ClassNotFoundException, SQLException {
        ...
        return DriverManager.getConnection(getJdbcUrl(dmConnectionParam), dmConnectionParam.getUser(), PasswordUtils.decodePassword(dmConnectionParam.getPassword()));
    }
