...
public class SparkSqlTask extends AbstractYarnTask {
     ...
     */
    private static final String SPARK1_COMMAND = "${SPARK_HOME1}/bin/spark-sql";

    /**
     * spark2 command
     * usage: spark-submit [options] <app jar | python file> [app arguments]
     */
    private static final String SPARK2_COMMAND = "${SPARK_HOME2}/bin/spark-sql";
    ...
    protected String buildCommand() {
        ...
        if (SparkSqlVersion.SPARK1.name().equals(sparksqlParameters.getSparkVersion())) {
        ...
        // other parameters
        args.addAll(SparkSqlArgsUtils.buildArgs(sparksqlParameters));
    ...
    protected void setMainJarName() {
        // main jar
        ResourceInfo mainJar = sparksqlParameters.getMainJar();
        ...
        sparksqlParameters.setMainJar(mainJar);
