...
public class DmsTaskTest {
    ...
    public void testCreateTaskJson() {
        ...
        Assert.assertEquals("arn:aws:dms:ap-southeast-1:511640773671:endpoint:Z7SUEAL273SCT7OCPYNF5YNDHJDDFRATGNQISOQ",
                dmsParametersNew.getSourceEndpointArn());
        Assert.assertEquals("arn:aws:dms:ap-southeast-1:511640773671:endpoint:aws-mysql57-target",
                dmsParametersNew.getTargetEndpointArn());
        Assert.assertEquals("arn:aws:dms:ap-southeast-1:511640773671:rep:dms2c2g",
