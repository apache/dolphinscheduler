...
public class FlinkSqlTask extends AbstractYarnTask {
     ...
     *  flink parameters
     */
    private FlinkSqlParameters flinkParameters;
    ...
    public void init() {
        ...
        flinkParameters = JSONUtils.parseObject(taskExecutionContext.getTaskParams(), FlinkSqlParameters.class);
    ...
    protected String buildCommand() {
        ...
        // other parameters
        args.addAll(FlinkSqlArgsUtils.buildArgs(flinkParameters));
