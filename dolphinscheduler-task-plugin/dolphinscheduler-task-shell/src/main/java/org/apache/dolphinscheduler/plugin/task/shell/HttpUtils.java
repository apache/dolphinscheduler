...
public class HttpUtils {
    ...
    static {
        ...
        requestConfig = RequestConfig.custom().setCookieSpec(CookieSpecs.IGNORE_COOKIES)
                ...
                .setConnectTimeout(TaskConstants.HTTP_CONNECT_TIMEOUT).setSocketTimeout(TaskConstants.SOCKET_TIMEOUT)
                .setConnectionRequestTimeout(TaskConstants.HTTP_CONNECTION_REQUEST_TIMEOUT).setRedirectsEnabled(true)
                .build();
