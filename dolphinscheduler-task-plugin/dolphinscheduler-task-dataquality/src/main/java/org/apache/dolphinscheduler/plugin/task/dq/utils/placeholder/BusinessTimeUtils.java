...
package org.apache.dolphinscheduler.plugin.task.dq.utils.placeholder;
...
public class BusinessTimeUtils {
    ...
    public static Map<String, String> getBusinessTime(CommandType commandType, Date runTime, String timezone) {
        ...
        result.put(DateConstants.PARAMETER_CURRENT_DATE,
                DateUtils.format(businessCurrentDate, DateConstants.PARAMETER_FORMAT_DATE, timezone));
        result.put(DateConstants.PARAMETER_BUSINESS_DATE,
                DateUtils.format(businessDate, DateConstants.PARAMETER_FORMAT_DATE, timezone));
        result.put(DateConstants.PARAMETER_DATETIME,
                DateUtils.format(businessCurrentDate, DateConstants.PARAMETER_FORMAT_TIME, timezone));
        return result;
    }
}
