...
public class TimePlaceholderUtils {
    ...
    private static String calculateTime(String expression, Date date) {
        ...
        try {
            if (expression.startsWith(TaskConstants.TIMESTAMP)) {
                String timeExpression = expression.substring(TaskConstants.TIMESTAMP.length() + 1, expression.length() - 1);
                ...
                Date timestamp = DateUtils.parse(dateStr, TaskConstants.PARAMETER_FORMAT_TIME);
    ...
    public static Map.Entry<Date, String> calcTimeExpression(String expression, Date date) {
        ...
        if (expression.startsWith(TaskConstants.ADD_MONTHS)) {
            resultEntry = calcMonths(expression, date);
        } else if (expression.startsWith(TaskConstants.MONTH_BEGIN)) {
            resultEntry = calcMonthBegin(expression, date);
        } else if (expression.startsWith(TaskConstants.MONTH_END)) {
            resultEntry = calcMonthEnd(expression, date);
        } else if (expression.startsWith(TaskConstants.WEEK_BEGIN)) {
            resultEntry = calcWeekStart(expression, date);
        } else if (expression.startsWith(TaskConstants.WEEK_END)) {
    ...
    public static Map.Entry<Date, String> calcMonthBegin(String expression, Date date) {
        String addMonthExpr = expression.substring(TaskConstants.MONTH_BEGIN.length() + 1, expression.length() - 1);
        String[] params = addMonthExpr.split(TaskConstants.COMMA);
    ...
    public static Map.Entry<Date, String> calcMonthEnd(String expression, Date date) {
        String addMonthExpr = expression.substring(TaskConstants.MONTH_END.length() + 1, expression.length() - 1);
        String[] params = addMonthExpr.split(TaskConstants.COMMA);
    ...
    public static Map.Entry<Date, String> calcWeekStart(String expression, Date date) {
        String addMonthExpr = expression.substring(TaskConstants.WEEK_BEGIN.length() + 1, expression.length() - 1);
        String[] params = addMonthExpr.split(TaskConstants.COMMA);
    ...
    public static Map.Entry<Date, String> calcWeekEnd(String expression, Date date) {
        String addMonthExpr = expression.substring(TaskConstants.WEEK_END.length() + 1, expression.length() - 1);
        String[] params = addMonthExpr.split(TaskConstants.COMMA);
    ...
    public static Map.Entry<Date, String> calcMonths(String expression, Date date) {
        String addMonthExpr = expression.substring(TaskConstants.ADD_MONTHS.length() + 1, expression.length() - 1);
        String[] params = addMonthExpr.split(TaskConstants.COMMA);
