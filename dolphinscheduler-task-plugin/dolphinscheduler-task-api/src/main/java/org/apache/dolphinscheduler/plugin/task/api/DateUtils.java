...
public class DateUtils {
    ...
    public static String getCurrentTime() {
        return getCurrentTime(TaskConstants.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String dateToString(Date date) {
        return format(date, TaskConstants.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static Date stringToDate(String str) {
        return parse(str, TaskConstants.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static Date getCurrentDate() {
        return DateUtils.parse(DateUtils.getCurrentTime(),
                TaskConstants.YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String getCurrentTimeStamp() {
        return getCurrentTime(TaskConstants.YYYYMMDDHHMMSSSSS);
    }
