                  ...
                  default: ({
                    ...
                    <NSpace style={{ width: '100%', flexWrap: 'nowrap' }}>
                      <NSelect
                        v-model={[value.location, 'value']}
                        options={getLocationOptions(
                          form.pollStatusInterface.method
                        )}
                        placeholder={t(
                          'thirdparty_api_source.param_location_tips'
                        )}
              ...
              {{
                ...
                default: () => (
                  <>
                    <NInput
                      v-model={[
                        form.pollStatusInterface.pollingSuccessConfig
                          .successField,
                        'value'
                      ]}
                      placeholder={t(
              ...
              {{
                ...
                default: () => (
                  <>
                    <NInput
                      v-model={[
                        form.pollStatusInterface.pollingFailureConfig
                          .failureField,
                        'value'
                      ]}
                      placeholder={t(
