...
const ListenerInstanceManage = defineComponent({
  ...
  render() {
    ...
    return (
      <NSpace vertical>
              ...
              <NSpace justify='space-between'>
                {IS_ADMIN && (
                  <NButton onClick={onCreate} type='primary' size='small'>
                    {t('security.listener_instance.create_listener_instance')}
                  </NButton>
                )}
                <NSpace justify='end' wrap={false}>
                  <Search
                    ...
                    placeholder={`${t(
                      'security.listener_instance.search_tips'
                    )}`}
        ...
        <Card title={t('menu.listener_instance_manage')}>
          <NSpace vertical>
            <NDataTable
              columns={columns}
              data={list}
...
export default ListenerInstanceManage
