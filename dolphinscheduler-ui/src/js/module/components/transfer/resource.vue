      ...
      <div class="clearfix transfer-model" style="width: 660px">
        <div>
            <el-button-group style="margin-bottom: 5px;">
                <el-button value="fileResource" size="mini" @click="_ckFile">{{$t('File resources')}}</el-button>
                <el-button value="udfResource" size="mini" @click="_ckUDf">{{$t('UDF resources')}}</el-button>
            </el-button-group>
        </div>
