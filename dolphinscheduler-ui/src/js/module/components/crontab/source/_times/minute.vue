      ...
      <el-radio-group v-model="radioMinute" vertical size="mini">
        ...
        <div class="list-box">
          <el-radio label="specificMinute" size="mini">
            ...
            <el-select multiple :placeholder="$t('请选择具体分钟数')" size="mini" v-model="specificMinutesVal" @change="onspecificMinutes">
              <el-option
  ...
  methods: {
    ...
    analyticalValue () {
      return new Promise((resolve, reject) => {
        const $minuteVal = _.cloneDeep(this.value)
        // Interval score
        const $interval = isStr($minuteVal, '/')
        // Specific points
        const $specific = isStr($minuteVal, ',')
        // Periodic Division
        const $cycle = isStr($minuteVal, '-')
