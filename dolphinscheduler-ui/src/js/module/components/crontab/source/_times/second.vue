      ...
      <el-radio-group v-model="radioSecond" vertical size="mini">
        ...
        <div class="list-box">
          <el-radio label="specificSecond">
            ...
            <el-select multiple size="mini" :placeholder="$t('请选择具体秒数')" v-model="specificSecondsVal" @change="onSpecificSeconds">
              <el-option
  ...
  methods: {
    ...
    analyticalValue () {
      return new Promise((resolve, reject) => {
        const $secondVal = _.cloneDeep(this.value)
        // Interval seconds
        const $interval = isStr($secondVal, '/')
        // Specific seconds
        const $specific = isStr($secondVal, ',')
        // Cycle second
        const $cycle = isStr($secondVal, '-')
