...
export default {
  ...
  Authorize: 'Authorize',
  Transfer: 'Transfer',
  'Please select the user to receive transferred data': 'Please select the user to receive transferred data',
  'Please select the data to be transferred': 'Please select the data to be transferred',
