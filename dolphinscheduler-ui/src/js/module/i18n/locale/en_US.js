...
export default {
  ...
  'Host List': 'Host List',
  'Please enter the Host address separated by commas': 'Please enter the Host address separated by commas',
  'Note: Multiple Host addresses have been comma separated': 'Note: Multiple Host addresses have been comma separated',
  ...
  'Host address cannot be empty': 'Host address cannot be empty',
  'Please enter the correct Host': 'Please enter the correct Host',
