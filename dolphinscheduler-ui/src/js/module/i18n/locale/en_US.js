...
export default {
  ...
  'Tenant Code': 'OS Tenant Code',
  Queue: 'Yarn Queue',
  'Tenant Name': 'Tenant Name',
  'Please select a queue': 'default is tenant association queue',
  'Please enter the tenant code in English': 'Please enter the os tenant code in English',
  'Please enter tenant code in English': 'Please enter os tenant code in English',
  'Please enter tenant code': 'Please enter os tenant code',
  'Please enter tenant Name': 'Please enter tenant Name',
  'The tenant code. Only letters or a combination of letters and numbers are allowed': 'The os tenant code. Only letters or a combination of letters and numbers are allowed',
  'The tenant code cannot be all numbers': 'The os tenant code cannot be all numbers',
  'Edit User': 'Edit User',
  Tenant: 'Tenant',
  Email: 'Email',
  Phone: 'Phone',
