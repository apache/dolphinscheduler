...
export default {
  ...
  'Edit token': '编辑令牌',
  'Host List': 'Host列表',
  'Please enter the Host address separated by commas': '请输入Host地址多个用英文逗号隔开',
  'Note: Multiple Host addresses have been comma separated': '注意：多个Host地址以英文逗号分割',
  'Failure time': '失效时间',
  ...
  'Host address cannot be empty': 'Host地址不能为空',
  'Please enter the correct Host': '请输入正确的Host',
