...
export default {
  ...
  '(Comparison-Statistics)/Comparison Percentage': '(期望值-实际值)/实际值 x 100%',
  'Comparison Statistics Difference': '期望值-实际值',
  'Comparison Minus Statistics': '期望值-实际值',
  'Statistics Minus Comparison': '实际值-期望值',
  'Statistics Comparison Percentage': '实际值/期望值 x 100%',
