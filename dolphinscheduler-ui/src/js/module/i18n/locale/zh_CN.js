...
export default {
  ...
  'Please enter the tenant code in English': '请输入操作系统租户只允许英文',
  'Please enter tenant code in English': '请输入英文操作系统租户',
  'Please enter tenant code': '请输入操作系统租户',
  'Please enter tenant Name': '请输入租户名称',
  'The tenant code. Only letters or a combination of letters and numbers are allowed': '操作系统租户只允许字母或字母与数字组合',
  'Edit User': '编辑用户',
  Tenant: '租户',
  Email: '邮件',
  Phone: '手机',
