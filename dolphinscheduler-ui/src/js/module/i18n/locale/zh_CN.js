...
export default {
  ...
  Threshold: '阈值',
  'Single Table': '单表检测',
  'Single Table Custon Sql': '自定义SQL',
  'Multi Table Accuracy': '跨表准确性',
  'Multi Table Comparison': '跨表值对比',
  'Statistics Compare Fixed Value': '统计值与阈值比较',
  'Statistics Compare Comparsion': '统计值与比对值比较',
  'Statistics Comparison Percentage': '统计值占比对值百分比',
  'End And Alert': '结束并告警',
  'Continue And Alert': '继续并告警'
}
