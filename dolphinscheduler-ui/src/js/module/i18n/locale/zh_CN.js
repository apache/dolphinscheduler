...
export default {
  ...
  'No more...': '没有更多了...',
  'Tasks queue manage':'任务组队列管理',
  'Create Tasksqueue':'创建任务组',
  'Edit Tasksqueue':'编辑任务组',
  'TQname':'任务组名称',
  'TQdes':'任务组描述',
  'TQnum':'任务组数量',
  'TQusernum':'用户数量',
  ...
  'TQcheck':'查看任务组',
  'Close?': '确定关闭任务组吗?',
  'Assigned Taskgroup':'指定工作任务组',
  'Please enter taskqueue name':'请输入任务组名称',
  'Please enter taskqueue description':'请输入任务组描述',
  'Please enter taskqueue size':'请输入任务组数量',
  'taskgroup name length is between 3 and 20':'任务组名称长度需要在3-20之间'
}
