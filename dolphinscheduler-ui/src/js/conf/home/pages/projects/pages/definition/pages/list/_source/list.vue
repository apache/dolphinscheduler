        ...
        <el-table-column :label="$t('Operation')" width="335" fixed="right">
          <template slot-scope="scope">
            ...
            <el-tooltip :content="$t('offline')" placement="top">
              <el-button type="error" size="mini" icon="el-icon-download" v-if="scope.row.releaseState === 'ONLINE'" @click="_downline(scope.row)" circle></el-button>
            </el-tooltip>
            ...
            <el-tooltip :content="$t('Cron Manage')" placement="top">
            ...
            <el-tooltip :content="$t('TreeView')" placement="top">
            ...
            <el-tooltip :content="$t('Version Info')" placement="top">
