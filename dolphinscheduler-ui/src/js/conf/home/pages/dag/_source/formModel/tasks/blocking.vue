...
<script>
  ...
  export default {
    ...
    created () {
      ...
      if (!_.isEmpty(o)) {
        let alert = o.params.alertWhenBlocking || false
        this.alertWhenBlocking = alert
        let blockingCondition = o.params.blockingCondition || 'BlockingOnFailed'
