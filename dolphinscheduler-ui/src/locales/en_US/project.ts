...
export default {
  ...
  node: {
    ...
    blocking_on_condition_failed: 'Blocking on pre task condition failed',
    blocking_on_condition_success: 'Blocking on pre task condition success',
    alert: 'Alert',
    do_not_alert: 'Do not alert',
    alert_on_blocking: 'Alert on blocking',
    blocking_opportunity: 'Blocking Opportunity',
