...
export default {
  ...
  node: {
    ...
    emr_serverless_application_id_tips: 'Please enter the EMR Serverless Application ID',
    ...
    emr_serverless_job_name_tips: 'Optional. Defaults to the task name if empty',
    emr_serverless_start_job_run_json: 'StartJobRun JSON',
    emr_serverless_start_job_run_json_tips: 'Please enter the StartJobRun request JSON (jobDriver, configurationOverrides, etc.)',
