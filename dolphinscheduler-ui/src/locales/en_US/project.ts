...
export default {
  ...
  workflow: {
    ...
    seconds: 'Seconds',
    repeat: 'Repeat',
    unlimited_repeat_tip: '-1 means unlimited repeats',
    interval_must_be_positive: 'Interval must be positive',
    misfire_policy: 'Misfire Policy',
    do_nothing: 'Skip missed executions',
    fire_and_proceed: 'Fire once immediately',
    ignore_misfires: 'Ignore misfires',
    delete_confirm: 'Delete?',
