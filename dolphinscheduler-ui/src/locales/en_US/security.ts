...
export default {
  ...
  task_remote_host: {
    create_task_remote_host: 'Create Task Remote Host',
    edit_task_remote_host: 'Edit Task Remote Host',
    search_tips: 'Please enter keywords',
    edit: 'Edit',
    delete: 'Delete',
    task_remote_host_name: 'Host Name',
    task_remote_host_ip: 'Host IP',
    task_remote_host_port: 'SSH Port',
    task_remote_host_account: 'Account',
    task_remote_host_password: 'Password',
    task_remote_host_desc: 'Host Desc',
    create_time: 'Create Time',
    update_time: 'Update Time',
    operation: 'Operation',
    delete_confirm: 'Delete?',
    task_remote_host_name_tips: 'Please enter your host name',
    task_remote_host_ip_tips: 'Please enter your host ip',
    task_remote_host_account_tips: 'Please enter your host account',
    task_remote_host_password_tips: 'Please enter your account password',
    task_remote_host_description_tips: 'Please enter your cluster description',
    task_remote_host_port_tips: 'Please enter your SSH port',
