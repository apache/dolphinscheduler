...
export default {
  ...
  listener_plugin: {
    register_plugin: 'Install Listener Plugin',
    search_tips: 'Enter keywords',
    ...
    create_time: 'Create Time',
    update_time: 'Update Time',
    class_path_tips: 'Please enter complete class name',
    plugin_jar_tips: 'Please upload plugin jar file',
    operation: 'Operation',
    edit: 'Edit',
    delete: 'Uninstall',
    delete_confirm: 'Are you sure you want to uninstall this plugin?',
  },
  listener_instance: {
    create_listener_instance: 'Create Listener Instance',
    edit_listener_instance: 'Edit Listener Instance',
    search_tips: 'Enter keywords',
    update_instance: 'Update Listener Instance',
    instance_name: 'Instance Name',
    select_plugin: 'Select Listener Plugin',
    select_plugin_tips: 'Please select the listener plugin',
    listener_event_types: 'Listen Event Types',
    create_time: 'Create Time',
    update_time: 'Update Time',
    instance_name_tips: 'Please enter the listener instance name',
    listener_event_types_tips: 'Please select the listen event types',
    operation: 'Operation',
    edit: 'Edit',
    delete: 'Delete',
    confirm: 'Confirm',
