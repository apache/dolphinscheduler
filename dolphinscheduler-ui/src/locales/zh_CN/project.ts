...
export default {
  ...
  workflow: {
    gantt_help: '时间轴说明',
    gantt_timeline: '任务执行时间轴',
    gantt_instance: '工作流实例',
    gantt_live: '运行中',
    gantt_finished: '已结束',
    gantt_total: '任务总数',
    gantt_submitted: '累计已提交',
    gantt_pending: '待提交',
    gantt_waiting: '排队 / 等待',
    gantt_running: '执行中',
    gantt_success: '成功',
    ...
    gantt_stale: '刷新失败，当前展示上次成功获取的数据，请重试。',
    gantt_load_error: '无法加载工作流实例，请检查服务连接和访问权限后重试。',
    gantt_empty: '该工作流实例没有任务。',
    gantt_loading: '正在加载任务执行情况…',
