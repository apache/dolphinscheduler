...
export default {
  ...
  task_remote_host: {
    create_task_remote_host: '创建任务远程主机',
    edit_task_remote_host: '编辑远程任务主机',
    search_tips: '请输入关键词',
    edit: '编辑',
    delete: '删除',
    task_remote_host_name: '主机名称',
    task_remote_host_ip: '主机IP',
    task_remote_host_port: 'SSH端口',
    task_remote_host_account: '主机账户',
    task_remote_host_password: '密码',
    task_remote_host_desc: '主机描述',
    create_time: '创建时间',
    update_time: '更新时间',
    operation: '操作',
    delete_confirm: '确定删除吗?',
    task_remote_host_name_tips: '请输入主机名称',
    task_remote_host_ip_tips: '请输出主机IP',
    task_remote_host_account_tips: '请输入主机账户',
    task_remote_host_password_tips: '请输入密码',
    task_remote_host_description_tips: '请输入主机描述',
    task_remote_host_port_tips: '请输入SSH端口',
    test_connect: '测试连接',
    success: '成功'
  },
  token: {
