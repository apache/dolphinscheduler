...
export default {
  ...
  listener_plugin: {
    ...
    create_time: '创建时间',
    update_time: '更新时间',
    class_path_tips: '请输入完整类名',
    plugin_jar_tips: '请上传插件jar包',
    operation: '操作',
    edit: '更新',
    delete: '卸载',
    delete_confirm: '确定卸载该插件吗?'
  },
  listener_instance: {
    create_listener_instance: '创建监听实例',
    edit_listener_instance: '修改监听实例',
    search_tips: '请输入关键词',
    update_instance: '更新监听实例',
    instance_name: '监听实例名称',
    select_plugin: '选择插件',
    select_plugin_tips: '请选择监听器插件',
    listener_event_types: '监听事件类型',
    create_time: '创建时间',
    update_time: '更新时间',
    instance_name_tips: '请输入监听实例名称',
    listener_event_types_tips: '请选择监听事件类型',
    operation: '操作',
    edit: '编辑',
    delete: '删除',
    confirm: '确定',
  ...
  listener_event: {
    ...
    workflow_end: '工作流执行成功',
    workflow_fail: '工作流执行失败',
    task_added: '新增任务',
    task_update: '更新任务',
    task_removed: '删除任务',
    task_start: '任务开始执行',
