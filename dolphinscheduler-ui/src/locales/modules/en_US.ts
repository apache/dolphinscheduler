...
const project = {
  ...
  node: {
    ...
    openmldb_zk_address: 'zk address',
    openmldb_zk_address_tips: 'Please enter the zk address',
    openmldb_zk_path: 'zk path',
    openmldb_zk_path_tips: 'Please enter the zk path',
