...
CLASS=org.apache.dolphinscheduler.tools.datasource.UpgradeDolphinScheduler

exec_command="-classpath $DOLPHINSCHEDULER_CONF_DIR:$DOLPHINSCHEDULER_LIB_JARS $CLASS"
