...
@Component
@Slf4j
public final class UpdateListenerPluginProcessor implements NettyRequestProcessor {

    private final ListenerPluginService listenerPluginService;

    public UpdateListenerPluginProcessor(ListenerPluginService listenerPluginService) {
