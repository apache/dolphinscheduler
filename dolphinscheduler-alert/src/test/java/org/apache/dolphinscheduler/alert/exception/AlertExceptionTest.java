...
public class AlertExceptionTest {
    ...
    public void testAlertException() {
        AlertException exception1 = new AlertException("alert exception test");
        Assert.assertNotNull(exception1);
        Throwable throwable = new Throwable("local stack reference");
        AlertException exception2 = new AlertException(throwable);
        Assert.assertNotNull(exception2);
        AlertException exception3 = new AlertException("alert exception test",throwable);
