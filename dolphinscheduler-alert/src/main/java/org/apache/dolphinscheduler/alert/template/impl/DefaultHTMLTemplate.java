...
public class DefaultHTMLTemplate implements AlertTemplate {
    ...
    public String getMessageFromTemplate(String content) {
        return getMessageFromTemplate(null,content);
    }

    @Override
    public String getMessageFromTemplate(String title, String content) {
        return null;
    }
}
