...
/**
 * DingTalkUtils utils support send msg to ding talk by robot message push
 * function. support proxy setting
 */
public class DingTalkUtils {
	...
	private static final Boolean isAtAll = PropertyUtils.getBoolean(Constants.DINGTALK_IS_AT_All);
	private static final String mobileList = PropertyUtils.getString(Constants.DINGTALK_MOBILE_LIST);

	/**
	 * send message interface only support text message format now.
	 * 
