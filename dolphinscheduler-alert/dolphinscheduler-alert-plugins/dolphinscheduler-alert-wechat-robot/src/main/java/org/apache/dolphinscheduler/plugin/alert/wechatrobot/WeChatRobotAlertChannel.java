...
public final class WeChatRobotAlertChannel implements AlertChannel {
    ...
    public AlertResult process(AlertInfo info) {
        ...
        return new WeChatRobotSender(paramsMap).sendEnterpriseWeChat(alertData.getTitle(), alertData.getContent());
