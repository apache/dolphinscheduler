...
public class ProcessDefinitionDemo implements CommandLineRunner {
    ...
    public void createProcessDefinitionDemo(){
        ...
        //clear log demo
        Map<String, Object> clearLogResult = clearLogDemo (loginUser, projectCode, tenantCode);
        logger.info("create clear log demo " + clearLogResult.get("msg"));

    }

    public Map<String, Object> clearLogDemo(User loginUser, long projectCode, String tenantCode){
